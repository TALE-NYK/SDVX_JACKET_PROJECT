...
class TunesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tune" do
    assert_difference("Tune.count") do
      post tunes_url, params: { tune: { difficulty: @tune.difficulty, memo: @tune.memo, name: @tune.name } }
    end
  ...
  test "should update tune" do
    patch tune_url(@tune), params: { tune: { difficulty: @tune.difficulty, memo: @tune.memo, name: @tune.name } }
